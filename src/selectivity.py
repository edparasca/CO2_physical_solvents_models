...
test_path = "../data/dataset_sel.csv"
...
# test_results_output_path = "../results/all_test_results.csv"
# final_test_results.to_csv(test_results_output_path, index=False)
# print(f"Saving results in: {test_results_output_path}")

metrics_df = pd.DataFrame(fold_metrics)

# metrics_output_path = "../results/fold_metrics.csv"
# metrics_df.to_csv(metrics_output_path, index=False)
# print(f"Saving metrics in: {metrics_output_path}")
...
final_agg.columns = [
    ...
    "Temperature (°C)",
    "OriginalValue",        # Pressure EXP (bar), mean
